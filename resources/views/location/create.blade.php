@extends("layouts.app")
@section("title","Lokasyon Oluştur")
@section("content")
    <div class="container">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route("location.store")}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" name="name" value="{{old("name")}}" class="form-control @error('name') is-invalid @enderror"/>
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input id="city" name="city" value="{{old("city")}}" class="form-control @error('city') is-invalid @enderror"/>
                                @error('city')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input id="district" name="district" value="{{old("district")}}" class="form-control @error('district') is-invalid @enderror"/>
                                @error('district')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input id="lat" name="lat" value="{{old("lat")}}" class="form-control @error('lat') is-invalid @enderror"/>
                                @error('lat')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input id="lng" name="lng" value="{{old("lng")}}" class="form-control @error('lng') is-invalid @enderror"/>
                                @error('lng')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
    ...
    <script>
        ...
        function initMap() {
            map = new google.maps.Map(document.getElementById('map'), {
                ...
                @if(session()->has("errors") && !($errors->has("lat") or $errors->has("lng")))
                    // to reMark map from old form inputs
                    center: {lat: {{old("lat")}}, lng: {{old("lng")}}},
                @else
